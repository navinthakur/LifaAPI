<?php
	...
	if ($getbannercount > 0) {while($getbannerrows = mysql_fetch_array($getbanner)){
	...
	//$faqarray[] = ["postid"=>"2","languagetype"=>"Hindi","videotype"=>"Server","posttitle"=>"Flutter History","postdescription"=>"Quick Discussion on flutter","postedfrom"=>"3 Days ago","postedby"=>"Navin Chand Thakur","posturl"=>"https://www.filepicker.io/api/file/KGRlz9rTt6l0hpxJjQHg"];
