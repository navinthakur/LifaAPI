...
if ($getProfileCount > 0) {
	...
	$json = array("status" => "1", "msg" => "Record Found!!","fullname" => $personname,"mobilenumber" => $mobilenumber,"alternateno"=> $alternatecontactno,"emailaddress" => $emailaddress,"dateofbirth" => $userdob,"address"=> $useraddress,"pincode"=> $userpincode,"location" => $userlocation,"city" => $usercity,"state" => $userstate,"isprofiletoshow" => $isprofiletoshow,"profilepicpath" => $profilepicpath,"institutename"=>$institutename,"licenceno"=> $licenceno,"courttype"=> $courttype,"courtlocation"=>$courtlocation,"occupationcat"=> $getProfileRows["usertype"],"courcename" => $courcename,"semname" => $semname,"malefemale" => $malefemale,"collgestate"=>$collgestate,"collegeunivecityname"=>$collegeunivecityname,"courceyear"=> $courceyear,"stepleft"=>$stepleft);
