          ...
          <div class="widget-content">
            ...
            <?php
              ...
              if (isset($_POST["BtnSubmitDetails"])) {
                ...
                if ($update) {
                  echo '<script>window.location = "clat_about.php?categoryid='.$categoryid.'&subcategoryid='.$subcategoryid.'&status=1&msg=Details Saved Successfully!!"</script>';
                }else{
                  echo '<script>window.location = "clat_about.php?categoryid='.$categoryid.'&subcategoryid='.$subcategoryid.'&status=0&msg=Sorry Something went Wrong!!"</script>';
                }
              }
            ?>
              <form class="well" style="background: #ffffff" method="post" action="" enctype="multipart/form-data"><div class="row-fluid">
                      <div class="span12">
                        <label>About </label>
