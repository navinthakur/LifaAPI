...
<?php
    ...
    if (isset($_POST["btnsubmitchapterdetails"])) {
       ...
       $actnametyperefid = $_POST["actnametyperefid"];
       $finalacttype=  $_POST["finalacttype"];

       for($i = 0; $i < $chapteritemcount; $i++){
          $actuniqueid = mt_rand(10000, 99999);
            $PropertyQuery = mysql_query("INSERT INTO `tblindianactchapter`(`coilanguagetype`,`actnametyperefid`,`finalacttype`,`indianactuniqueid`,`indianacttile`, `indianactchapter`, `indiansectionchapter`) VALUES ('$languagetype','$actnametyperefid','$finalacttype','$actuniqueid','$chapterintro[$i]','$actchapter[$i]','( $chapterstartfrom[$i] to $chapterendfrom[$i]) ')");
       }
       if ($PropertyQuery) {
       // $msg =  '<label class="label label-success">Details Saved Successfully!!</label><br><br>';
        echo '<script>window.location = "indianacts.php?status=1&msg=Details Saved Successfully!!"</script>';

      }else{
        //$msg = '<label class="label label-danger">Sorry Something Went Wrong!!</label><br><br>';

        echo '<script>window.location = "indianacts.php?status=0&msg=Sorry Something went Wrong!!"</script>';
      }
    ...
    if (isset($_POST["actname"])) {
      $itemcount = count($_POST["actitem_no"]);
      $actname = $_POST["actname"];
      for($i = 0; $i < $itemcount; $i++){
        $actquery = mysql_query("INSERT INTO `tblindianacts`(`acttitle`) VALUES ('$actname[$i]')");
      }
      if ($actquery) {
         // $msg =  '<label class="label label-success">Details Saved Successfully!!</label><br><br>';
          echo '<script>window.location = "indianacts.php?current=coisection&status=1&msg=Details Saved Successfully!!"</script>';

        }else{
          //$msg = '<label class="label label-danger">Sorry Something Went Wrong!!</label><br><br>';

          echo '<script>window.location = "indianacts.php?current=coisection&status=0&msg=Sorry Something went Wrong!!"</script>';
        }
    ...
    if (isset($_POST["BtnSubmitDetails"])) {
      ...
      $ChapterExplanation = $_POST["ChapterExplanation"];
       ...
       for($i = 0; $i < $itemcount; $i++){
           $PropertyQuery = mysql_query("INSERT INTO `tblindianactssection`(`indianactsectionlanguagetype`,`indianactsectionactno`,`indianactsectionacttitle`, `indianactactintro`, `indianactsectionrefid`) VALUES ('$sectionlanguagetype','$Sectionno[$i]','$ChapterTitle[$i]','$ChapterExplanation[$i]','$selectedappuniqueid')");
        }
...
<div id="main-content">
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="active">Indian Acts</li>
    </ul>
              ...
              <div class="box-tab">
                <div class="tabbable"> 
                  ...
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="#actpanel" data-toggle="tab">Add New Act</a></li>
                    <li><a href="#chapterpanel" data-toggle="tab">Add New Chapter</a></li>
                    <li><a href="#sectionpanel" data-toggle="tab">Add New Section</a></li>
                  </ul>
                  <div class="tab-content">
                    <div class="tab-pane active" id="actpanel">
                      <form class="" method="post" action="">
                        <div class="row-fluid">
                          <div class="span3">
                            <div class="control-group">
                              <label>Act Name</label>
                              <input type="hidden" name="actitem_no[]" id="actitem_no_0" value="1">
                              <input type="text" style="width: 100%" name="actname[]" id="actname_0" class="form-control actname" placeholder="For Ex: Indian partnership act, 1932">
                            </div>
                          </div>
                          <div class="span3" style="margin-top: 20px">
                            <div class="control-group">
                              <button type="button" id="addmoreact" class="btn btn-info addmoreact">Add More</button>
                            </div>
                          </div>
                        </div>
                        <div id="actdiv"></div>
                        <div class="row-fluid">
                          <div class="span3" style="margin-top: 20px">
                            <div class="control-group">
                              <button type="submit" class="btn btn-info" name="BtnSubmitActDetails">Submit</button>
                            </div>
                          </div>
                        </div>
                      </form>
                    </div>
                    <div class="tab-pane" id="chapterpanel">
                      <form class="" method="post" action="">
                        <div class="">
                            <br>
                            <div class="">
                              <div class="span3">
                                <div class="control-group">
                                  <label class="">Select ACT</label>
                                  <select class="form-control select2 actnametyperefid" name="actnametyperefid" id="actnametyperefid" style="width: 100%">
                                    <option value="">Select Act Name</option>
                                    <?php 
                                      $getindianact = mysql_query("select * from tblindianacts");
                                      while($getindianactrows = mysql_fetch_array($getindianact)){

                                    ?>
                                    <option value="<?php echo $getindianactrows["actid"]?>"><?php echo $getindianactrows["acttitle"]?></option>
                                    <?php
                                      }
                                    ?>
                                  </select>
                              ...
                              <div class="span3">
                                <div class="control-group">
                                  <label class="">Act Type</label>
                                  <select class="form-control select2 finalacttype" name="finalacttype" id="finalacttype" style="width: 100%">
                      ...
                      <!-- <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="btn btn-primary btn-md" id="" name="" style="margin-top: -5px;">Add New Chapter</a>
                    ...
                    <div class="tab-pane" id="sectionpanel">
                      <form class="" method="post" action="">
                        <br>
                        <div class="row-fluid">
                          <div class="span12">
                            <div class="span3">
                              <div class="control-group">
                                ...
                                <?php
                                    $getchapter = mysql_query("SELECT * FROM `tblindianactchapter`");
                                    while($getchapterrows = mysql_fetch_array($getchapter)){

                                  ?>
                                  <option value="<?php echo $getchapterrows["indianactuniqueid"]?>"><?php echo $getchapterrows["indianactchapter"]?> <?php echo $getchapterrows["indiansectionchapter"]?> </option>
                                  <?php
                                      }
                                  ?>
                              </select>
