...
<?php
  if (isset($_GET["del"])) {
    ...
    if ($delq) {
      echo '<script>window.location = "exampointfirst.php?status=1&msg=Details Deleted Successfully!!"</script>';
    }else{
      echo '<script>window.location = "exampointfirst.php?status=0&msg=Sorry Something went Wrong!!"</script>';
    }
  }
    if (isset($_POST["btnsubmitstream"])) {
      ...
      if ($streamquery) {
         echo '<script>window.location = "exampointfirst.php?status=1&msg=Details Saved Successfully!!"</script>';
      }else{
        echo '<script>window.location = "exampointfirst.php?status=0&msg=Sorry Something went Wrong!!"</script>';
      }
    }
          ...
          <div class="widget-content">
            <div class="widget-box">
              <?php
                if (isset($_POST["btnUpdateStream"])) {
                  ...
                  if ($updatestreamquery) {
                     echo '<script>window.location = "exampointfirst.php?status=1&msg=Details Updated Successfully!!"</script>';
                  }else{
                    echo '<script>window.location = "exampointfirst.php?status=0&msg=Sorry Something went Wrong!!"</script>';
                  }
              ...
              <div class="row-fluid">
                ...
                <div class="row-fluid">
                  <div class="span5">
                    <a href="exampointsecond.php?courseid=<?php echo $getfaqrows["courseid"]?>">    
                      <div class="stat-block">
                        <ul>
                          <li class="stat-count" style="width: 100%">
                              <span>
                                <?php echo $getfaqrows["coursefullform"]?> <b style="font-weight: 900">( <?php echo $getfaqrows["coursename"]?> )</b>
                              </span>
                              
                              <span>
                                <b>Course: </b><?php echo $getfaqrows["courseyear"]?>
                                <a href="exampointfirst.php?del=<?php echo $getfaqrows["courseid"]?>"> <span class="black-icons trashcan pull-right"></span></a>
                                  <a href="exampointfirst.php?view=<?php echo $getfaqrows["courseid"]?>"> <span class="black-icons pencil pull-right"></span></a>
