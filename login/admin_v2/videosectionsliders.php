<?php include("header.php");?>
  ...
  if (isset($_GET["del"])) {
    ...
    if ($delquery) {
       echo '<script>window.location = "videosectionsliders.php?status=1&msg=Image Deleted Successfully!!"</script>';
    }else{
       echo '<script>window.location = "videosectionsliders.php?status=0&msg=Sorry Something went Wrong!!"</script>';
    }
  }
    ...
    if (isset($_POST["btnsubmitstream"])) {
      ...
      if ($testseries) {
        echo '<script>window.location = "videosectionsliders.php?status=1&msg=Details Saved Successfully!!"</script>';
      }else{
        echo '<script>window.location = "videosectionsliders.php?status=0&msg=Sorry Something went Wrong!!"</script>';
      }
    }
...
<div id="main-content">
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="active">CLAT SLIDER</li>
    </ul>
              ...
              <table class="table table-bordered text-center data-tbl-inbox">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="center">
                      <a href="http://35.194.40.144/agentbhai/law/mobileapi/<?php echO $gettestseriesrows["clatsliderurl"]?>" target="_blank">View Photo</a>
                    </td>
                    ...
                    <td class="">
                      <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="clatsliders.php?del=<?php echo $gettestseriesrows["clatsliderid"]?>"><i class="icon-trash"></i> Remove Image</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
