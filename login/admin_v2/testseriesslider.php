<?php include("header.php");?>
  ...
  if (isset($_GET["del"])) {
    $seriesid = $_GET["del"];
    $delquery = mysql_query("delete from testseriesslider where clatsliderid='$seriesid'");
    if ($delquery) {
       echo '<script>window.location = "testseriesslider.php?status=1&msg=Image Deleted Successfully!!"</script>';
    }else{
       echo '<script>window.location = "testseriesslider.php?status=0&msg=Sorry Something went Wrong!!"</script>';
    }
  }
    ...
    if (isset($_POST["btnsubmitstream"])) {
      ...
      $testseries = mysql_query("INSERT INTO `testseriesslider`(`slidertitle`, `clatsliderurl`) VALUES ('$SeriesSection','$AgreementPath')");

      if ($testseries) {
        echo '<script>window.location = "testseriesslider.php?status=1&msg=Details Saved Successfully!!"</script>';
      }else{
        echo '<script>window.location = "testseriesslider.php?status=0&msg=Sorry Something went Wrong!!"</script>';
      }
    }
...
<div id="main-content">
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="active">TEST SERIES SLIDER</li>
    </ul>
            ...
            <div class="widget-box">
              ...
              if (isset($_POST["btnupdatestream"])) {
                ...
                $UpdateSeriesSection = $_POST["UpdateSeriesSection"];
                  ...
                  if ($iscompanylogoselected == "1") {
                    ...
                    mysql_query("UPDATE `testseriesslider` SET `clatsliderurl`='$AgreementPath' WHERE `clatsliderid`='$clatsliderid'");
                  }
                  $testseries = mysql_query("UPDATE `testseriesslider` SET `slidertitle`='$UpdateSeriesSection' WHERE `clatsliderid`='$clatsliderid'");

                  if ($testseries) {
                    echo '<script>window.location = "testseriesslider.php?status=1&msg=Details Updated Successfully!!"</script>';
                  }else{
                    echo '<script>window.location = "testseriesslider.php?status=0&msg=Sorry Something went Wrong!!"</script>';
                  }
                }
                if (isset($_GET["view"])) {
                  ...
                  $getdetails = mysql_query("select * from testseriesslider where clatsliderid='$clatsliderid'");
              ...
              <table class="table table-bordered text-center data-tbl-inbox">
                ...
                <tbody>
                  <?php
                  $count = 1;
                    $gettestseries = mysql_query("SELECT * FROM `testseriesslider`");
                    ...
                    <td class="">
                      <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="testseriesslider.php?view=<?php echO $gettestseriesrows["clatsliderid"]?>"><i class="icon-edit"></i> View/Edit Slider</a></li>
                          <li><a href="testseriesslider.php?del=<?php echo $gettestseriesrows["clatsliderid"]?>"><i class="icon-trash"></i> Remove Image</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
