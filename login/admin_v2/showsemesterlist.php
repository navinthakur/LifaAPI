...
if (isset($_GET["del"])) {
    ...
    if ($delq) {
      echo '<script>window.location = "showsemesterlist.php?courseid='.$courseid.'&status=1&msg=Details Deleted Successfully!!"</script>';
    }else{
      echo '<script>window.location = "showsemesterlist.php?courseid='.$courseid.'&status=0&msg=Sorry Something went Wrong!!"</script>';
    }
  }
...
<?php
  if (isset($_POST["btnsubmitstream"])) {
    ...
    if ($addsemester) {
      echo '<script>window.location = "showsemesterlist.php?courseid='.$courseid.'&status=1&msg=Details Saved Successfully!!"</script>';
    }else{
      echo '<script>window.location = "showsemesterlist.php?courseid='.$courseid.'&status=0&msg=Sorry Something went Wrong!!"</script>';
    }
  }
        ...
        <div class="nonboxy-widget">
          ...
          <div class="widget-content">
            <div class="widget-box">
              ...
              <a href="syllabus.php" class="btn btn-success btn-md">Go Back</a>
              ...
              <div class="row-fluid">
                ...
                <div class="row-fluid">
                <div class="span3">
                    <a href="showsubjectlist.php?courseid=<?php echo $_GET["courseid"]?>&semesterid=<?php echo $getfaqrows["semesterid"]?>&txtDisplay=<?php echo $getfaqrows["semestername"]?> <?php echo $count?>">
                      <div class="stat-block">
                        <ul>
                          <li class="stat-count" style="width: 100%">
                            <span><?php echo $getfaqrows["semestername"]?> <?php echo $count?> </span>
                            <a href="showsemesterlist.php?del=<?php echo $getfaqrows["semesterid"]?>&courseid=<?php echo $_GET["courseid"]?>" class="pull-right"> <span class="black-icons trashcan "></span></a>
                          </li>                      
                        </ul>
                      </div>
                    </a>
